...
void test_BarnsleyFern()
{
    ...
    BarnsleyFernGPUTime = MeasureTime(&barnsley, &lsystem::executeOnGPUWithModules, iteration, 35);
}
...
void test_DragonCurve()
{
    ...
    std::cout << "GPU execution..." << std::endl;
    DragonCurveGPUTime = MeasureTime(&dragon, &lsystem::executeOnGPUWithModules, iteration, 32);
}
...
void test_HilbertCurve()
{
    ...
    std::cout << "GPU execution..." << std::endl;
    HilbertCurveGPUTime = MeasureTime(&hilbert, &lsystem::executeOnGPUWithModules, iteration, 30);
}
...
void test_IslandCurve()
{
    ...
    std::cout << "GPU execution..." << std::endl;
    IslandCurveGPUTime = MeasureTime(&island, &lsystem::executeOnGPUWithModules, iteration, 10);
}
...
void test_KochCurve()
{
    ...
    std::cout << "GPU execution..." << std::endl;
    KochCurveGPUTime = MeasureTime(&koch, &lsystem::executeOnGPUWithModules, iteration, 15);
}
...
void test_Pentaplexity()
{
    ...
    std::cout << "GPU execution..." << std::endl;
    PentaplexityGPUTime = MeasureTime(&pentaplexity, &lsystem::executeOnGPUWithModules, iteration, 33);
}
...
void test_PitaevskiiTree()
{
    ...
    std::cout << "GPU execution..." << std::endl;
    PitaevskiiGPUTime = MeasureTime(&pitaevskii, &lsystem::executeOnGPUWithModules, iteration, 10);
}
...
void test_SierpinskiArrowhead()
{
    ...
    std::cout << "GPU execution..." << std::endl;
    ArrowheadGPUTime = MeasureTime(&arrowhead, &lsystem::executeOnGPUWithModules, iteration, 20);
}
...
void test_SierpinskiTriangle()
{
    ...
    std::cout << "GPU execution..." << std::endl;
    TriangleGPUTime = MeasureTime(&triangle, &lsystem::executeOnGPUWithModules, iteration, 28);
}
...
void test_Sticks()
{
    ...
    std::cout << "GPU execution..." << std::endl;
    SticksGPUTime = MeasureTime(&sticks, &lsystem::executeOnGPUWithModules, iteration, 12);
}
...
void writeResults()
{
    std::ofstream outputFile("ResultsWithModules.txt");
